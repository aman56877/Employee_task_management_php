...
$queryforManagerToken = "SELECT * from registrationdata WHERE token = '$token'";
    ...
    if($image == ""){
        ...
        if($ManagerDepartment === 'it_dept'){
            ...
            if($querytoUpdateInfoInDeptResult){
                ...
                header("location:my_profile_for_manager.php");
            }else{
...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li>
                        <a class="nav-link active" aria-current="page"
                            href="finance_dept_for_manager.php">Department</a>
                    </li>
    ...
    function unsetSession(){
        ...
        xhr.open("GET", "my_profile_for_manager.php?unset=1", true);
        xhr.send();
    }
    </script>';
    ?>
