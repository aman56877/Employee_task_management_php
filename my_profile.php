...
if (isset($_POST['submit'])) {
    ...
    if($image == ""){
        $query = "UPDATE registrationdata SET name = '$name', email = '$email', number = '$number', city = '$city', zip = '$zip', updated_at = NOW() WHERE token = '$token'";
        $result = mysqli_query($conn, $query);
        $_SESSION['updationOfDataOnly'] = "Your personal information has been updated";
    }else{
        $deleteQuery = "SELECT * FROM registrationdata WHERE token = '$token'";
        $deleteResult = mysqli_query($conn, $deleteQuery);
        if($deleteResult && mysqli_num_rows($deleteResult)>0){
            $user = mysqli_fetch_assoc($deleteResult);
            $previousProfile = $user['profile'];
            if($previousProfile !== NULL){
                unlink("profile/" . $previousProfile);
            }
        }
        $query = "UPDATE registrationdata SET name = '$name', email = '$email', number = '$number', city = '$city', zip = '$zip', profile = '$image', updated_at = NOW() WHERE token = '$token'";
        $result = mysqli_query($conn, $query);
                ...
                <div class="col-4">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" value="<?php echo $alldata['name'];  ?>" name="name">
                    </div>
                </div>
                <div class="col-4">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" value="<?php echo $alldata['email'];  ?>" name="email">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-start">
                <div class="col-4">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" value="<?php echo $alldata['number'];  ?>" name="number">
                    </div>
                </div>
                <div class="col-4">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" value="<?php echo $alldata['city'];  ?>" name="city">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-start">
                <div class="col-4">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input"
                        aria-describedby="inputGroup-sizing-default" value="<?php echo $alldata['zip'];  ?>" name="zip">
                        <p>
                            <?php
